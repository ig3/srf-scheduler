...
function setup2 () {
  ...
  self.db.prepare(`
    insert into revlog (
      ...
      (unixepoch() * 1000 - 68400000 * 2 - 3, @d1, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 * 2 - 2, @d1, 1, 'good', 60 * 5, 30, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 * 2 - 1, @d1, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 - 4, @d2, 1, 'good', 60 * 5, 500, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 - 3, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 - 2, @d2, 1, 'good', 60 * 5, 1000000, 1.8, 10, 10),
      (unixepoch() * 1000 - 68400000 - 1, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
