...
t.test('getAverageReviewsPerDay', t => {
  ...
  const result3 = getAverageReviewsPerDay.call(setup2(), 1);
  t.equal(result3, 8, '8 reviews in 1 whole day - prior days are ignored');

  const result4 = getAverageReviewsPerDay.call(setup3());
...
function setup2 () {
  ...
  self.db.prepare(`
    insert into revlog (
      ...
      ((unixepoch() * 1000) - 86400000 - 4, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
