...
function setup3 () {
  ...
  self.db.prepare(`
    insert into revlog (
      ...
      (@ts - 86400000 * 20 - 10, @d1, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 86400000 * 20 - 9, @d1, 1, 'good', 60 * 5, 30, 1.8, 10, 10),
      (@ts - 86400000 * 20 - 8, @d1, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 86400000 - 5007, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 86400000 - 5006, @d2, 1, 'good', 60 * 5, 500, 1.8, 10, 10),
      (@ts - 86400000 - 5005, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 86400000 - 5004, @d2, 1, 'good', 60 * 5, 1000000, 1.8, 10, 10),
      (@ts - 86400000 - 5003, @d2, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 5002, @d3, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
      (@ts - 5001, @d3, 1, 'good', 60 * 5, 0, 1.8, 10, 10),
